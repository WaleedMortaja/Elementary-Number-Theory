...
public class LCMController implements Initializable {
    ...
    @FXML
    private void handleGetLCM(ActionEvent event) {
        try {
            Result.setText(numberTheory.NumberTheoryUtil.lcm(HelpingClass.input2ArrayOfLongs(Input)) + "");
